namespace Home_Visits_Vaccination
{
	partial class Main_Interface_Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "This form works right now,\r\nso I don\'t want to break it.\r\n(See \"Form2.<extensions" +
    ">\" for something\r\nwhere I\'m trying to duplicate/work with\r\nDelatorre\'s VanAnimat" +
    "ion demo.)";
			// 
			// Main_Interface_Form
			// 
			...
			this.Text = "Vaccination Manager (Form1)";
