namespace CSharpWithFirebase
{
	partial class MapForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonFirebaseForm = new System.Windows.Forms.Button();
			...
			// buttonFirebaseForm
			// 
			this.buttonFirebaseForm.Location = new System.Drawing.Point(468, 12);
			this.buttonFirebaseForm.Name = "buttonFirebaseForm";
			this.buttonFirebaseForm.Size = new System.Drawing.Size(136, 23);
			this.buttonFirebaseForm.TabIndex = 1;
			this.buttonFirebaseForm.Text = "TalkToFirebaseForm";
			this.buttonFirebaseForm.UseVisualStyleBackColor = true;
			this.buttonFirebaseForm.Click += new System.EventHandler(this.buttonTalkToFirebaseForm);
			// 
			...
			this.Controls.Add(this.buttonFirebaseForm);
		...
		private System.Windows.Forms.Button buttonFirebaseForm;
